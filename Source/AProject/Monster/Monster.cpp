...
AMonster::AMonster()
{
	...
	//아이템
	m_DropItemNameArray.Add(TEXT("태양의방패"));
	m_DropItemNameArray.Add(TEXT("HP포션"));
	m_DropItemNameArray.Add(TEXT("단검"));
	m_DropItemNameArray.Add(TEXT("화염구"));
	m_DropItemNameArray.Add(TEXT("미스릴갑옷"));
	m_DropItemNameArray.Add(TEXT("미스릴반지"));
	m_DropItemNameArray.Add(TEXT("사파이어목걸이"));
	m_DropItemNameArray.Add(TEXT("공격력강화포션"));
}
