...
#include "BTService_DataSet.h"
#include "../Player/PlayerCharacter.h"
#include "../Monster/Monster.h"
#include "../Monster/MonsterAIController.h"
#include "../DebugClass.h"

UBTService_DataSet::UBTService_DataSet()
{
	NodeName = TEXT("Detect");
	Interval = 0.5f;
}

void UBTService_DataSet::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	//LOG(TEXT("AA"));
